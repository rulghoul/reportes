...
public class MargenUtilidad {
    ...
    private void createMargen(VhcBoletinprecio boletin){
        ...
        this.margenUtilidad = VhcMargenUtilidad.builder()
                ...
                .precioLista(precio)
                .precioCredito(this.financiamientoPrecioPromocional)
                .precioContado(this.contadoPrecio)
                .precioListaUtilidadSinImpuestoMonto(listaMonto)
                .precioListaUtilidadSinImpuestoPorc(listaPorcentaje)
                .precioCreditoUtilidadSinImpuestoMonto(creditoMonto)
                .precioCreditoUtilidadSinImpuestoPorc(creditoPorcentaje)
                .precioContadoUtilidadSinImpuestoMonto(contadoMonto)
                .precioContadoUtilidadSinImpuestoPorc(contadoPorcentaje)
