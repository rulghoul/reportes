...
/**
 * JPA entity class for "VhcMarcaarchivotipo"
 *
 * @author Telosys
 *
 */
@Entity
@Table(name="vhc_marcaarchivotipo", catalog="adistemdb" )
public class VhcMarcaarchivotipo implements Serializable {
    ...
    @Id
    @Lob
    @Column(name="IDMARCAARCHIVOTIPO", nullable=false)
