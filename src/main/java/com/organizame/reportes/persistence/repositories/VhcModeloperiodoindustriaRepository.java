...
/**
 * Spring Data JPA repository for entity "VhcModeloperiodoindustria" <br> 
 * 
 ...
 *
 */
public interface VhcModeloperiodoindustriaRepository extends PagingAndSortingRepository<VhcModeloperiodoindustria, byte[]> {

	// Insert specific finders here 

	//List<VhcModeloperiodoindustria> findByXxx(String xxx);

	//List<VhcModeloperiodoindustria> findByXxxStartingWith(String xxx);

	//List<VhcModeloperiodoindustria> findByXxxContaining(String xxx);

	//List<VhcModeloperiodoindustria> findByYyy(BigDecimal yyy);

	//List<VhcModeloperiodoindustria> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
