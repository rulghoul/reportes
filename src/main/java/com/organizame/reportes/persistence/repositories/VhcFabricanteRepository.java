...
/**
 * Spring Data JPA repository for entity "VhcFabricante" <br> 
 * 
 ...
 *
 */
public interface VhcFabricanteRepository extends PagingAndSortingRepository<VhcFabricante, byte[]> {

	// Insert specific finders here 

	//List<VhcFabricante> findByXxx(String xxx);

	//List<VhcFabricante> findByXxxStartingWith(String xxx);

	//List<VhcFabricante> findByXxxContaining(String xxx);

	//List<VhcFabricante> findByYyy(BigDecimal yyy);

	//List<VhcFabricante> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
