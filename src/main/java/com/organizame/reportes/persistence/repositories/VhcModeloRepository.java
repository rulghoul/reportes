...
/**
 * Spring Data JPA repository for entity "VhcModelo" <br> 
 * 
 ...
 *
 */
public interface VhcModeloRepository extends PagingAndSortingRepository<VhcModelo, byte[]> {

	// Insert specific finders here 

	//List<VhcModelo> findByXxx(String xxx);

	//List<VhcModelo> findByXxxStartingWith(String xxx);

	//List<VhcModelo> findByXxxContaining(String xxx);

	//List<VhcModelo> findByYyy(BigDecimal yyy);

	//List<VhcModelo> findByXxxContainingAndYyy(String xxx, BigDecimal yyy);
}
